...
Activate the virtual environment (Windows) bs1
...
To install the packages listed in the requirements.txt file, you can use the 
pip install command with the -r flag:
